...
file22 = open('Data/qmdiag/spectrum.dat', 'w')
#------------------------------------------------------------------------------
#   input parameters                                                                 
#------------------------------------------------------------------------------
...
f    = float(f) #minimum of harmonic oxillator: (x^2-f^2)^2
ndim = int(ndim)#dimension of basis used for diagonalizing H (choose N >= 40)
w0   = float(w0)#unperturbed oscillator frequency (w0 = 4f)
...
#------------------------------------------------------------------------------
#     Calculate spectrum of hanarmonic oscillator                                                
#------------------------------------------------------------------------------
f = 0.0
